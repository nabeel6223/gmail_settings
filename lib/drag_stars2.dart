...
class GmailStarsSettings extends StatefulWidget {
  GmailStarsSettings({
    Key? key,
    this.depth = 0,
    this.valuePrefix = '',
  ...
  @override
  State createState() => _GmailStarsSettingsState();
}

class _GmailStarsSettingsState extends State<GmailStarsSettings> {
//  List<Widget> _tiles;
  Color? _color;
        ...
        child: Row(
          ...
          children: <Widget>[
                  ...
                  widget._tiles.add(Card(
                    child: Container(
                      child: Text(
                          ...
                          textScaleFactor: 3 / math.sqrt(widget.depth + 1)),
            ...
            IconButton(
              ...
              onPressed: () {
                setState(() {
                  widget._tiles.add(GmailStarsSettings(
